...
class Hybrid_Providers_Vkontakte extends Hybrid_Provider_Model_OAuth2
{
	...
	*/
	function getUserProfile()
	{
		...
		$params['user_id'] = Hybrid_Auth::storage()->get( "hauth_session.{$this->providerId}.user_id" );
		$params['fields'] = 'first_name,last_name,nickname,screen_name,sex,bdate,timezone,photo_rec,photo_big,city,country';
        $params['v'] = '5.24';
		...
		$this->user->profile->city          = (property_exists($response,'city'))?$response->city->title:"";
		$this->user->profile->country       = (property_exists($response,'country'))?$response->country->title:"";
